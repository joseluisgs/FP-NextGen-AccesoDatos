...
fun getRepresentantesInit() = listOf(
    Representante(nombre = "Pepe Perez", email = "pepe@perez.com"),
    Representante(nombre = "Juan Lopez", email = "juan@lopez.com"),
    Representante(nombre = "Maria Garcia", email = "maria@garcia.com"),
)
