package es.joseluisgs.p02encordadosmongodbjpa.db;
...
import es.joseluisgs.p02encordadosmongodbjpa.models.Representante;
...
public final class DataDB {
    ...
    public static List<Representante> getRepresentantes() {
        return List.of(
                new Representante("Juan Perez", "juan@perez.com"),
                new Representante("Jorge Luis", "jorge@luis.com"),
                new Representante("Ana Lopez", "ana@lopez.com")
        );
    }
