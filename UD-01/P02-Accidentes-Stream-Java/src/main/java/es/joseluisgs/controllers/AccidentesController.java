...
import es.joseluisgs.models.Accidente;
...
public class AccidentesController {
    ...
    private void loadData() {
        String dataPath = "data" + File.separator + "accidentes.csv";
    ...
    private void accidentesFinesDeSemanaNocheAlcohol() {
        ...
        System.out.println("Numero de accidentes Fines de semana de noche con positivo en alcohol: " + res);
    }
    ...
    private void accidentesFinesDeSemanaNoche() {
        ...
        var res = accidentes.parallelStream()
    ...
    private void estadisticasPorDistritos() {
        ...
        var maximo = resBarrios.entrySet().parallelStream()
        ...
        var minimo = resBarrios.entrySet().parallelStream()
    ...
    private void accidentesAlcoholDrogas() {
        ...
        var numero = accidentes.parallelStream().filter(alcohol.and(drogas)).count();
