package es.joseluisgs.consultas;


import es.joseluisgs.model.Product;
import es.joseluisgs.utils.Util;
...
//        La interfaz Comparator nos proporciona algunos métodos que nos serán útiles para las ordenaciones.
//        Existe una clase Collections que tiene un método reverseOrder() el cual devuelve un Comparator que impone el
//        reverso de una ordenación.
//        Hay que tener cuidado donde se aplican las operaciones como reversos, ya que podríamos aplicarlos a toda la
//        colección y no a los campos que deseamos.
...
//        la cual nos proporciona varios métodos de funciones de agregado. En este ejemplo, usamos el método groupingBy
